...
function converter(value, unit, toUnit) {
  ...
  var v = convertToCore(value, unit);
  if (unit === '₡') unit = 'core';
  ...
  if (unit !== 'ore') {
    result.ore = v.times(new BigNumber(1000000000000000000)).toFixed();
  }
  if (unit !== 'wav') {
    result.wav = v.times(new BigNumber(1000000000000000)).toFixed();
  }
  if (unit !== 'grav') {
    result.grav = v.times(new BigNumber(1000000000000)).toFixed();
  }
  if (unit !== 'nucle') {
    result.nucle = v.times(new BigNumber(1000000000)).toFixed();
  }
  if (unit !== 'atom') {
    result.atom = v.times(new BigNumber(1000000)).toFixed();
  }
  if (unit !== 'moli') {
    result.moli = v.times(new BigNumber(1000)).toFixed();
  }
  if (unit !== 'core') {
    result.core = v.times(new BigNumber(1)).toFixed();
  }
  if (unit !== 'aer') {
    result.aer = v.times(new BigNumber(0.001)).toFixed();
  }
  if (unit !== 'orb') {
    result.orb = v.times(new BigNumber(0.000001)).toFixed();
  }
  if (unit !== 'plano') {
    result.plano = v.times(new BigNumber(0.000000001)).toFixed();
  }
  if (unit !== 'tera') {
    result.tera = v.times(new BigNumber(0.000000000001)).toFixed();
  }
  if (unit !== 'sola') {
    result.sola = v.times(new BigNumber(0.000000000000001)).toFixed();
  }
  if (unit !== 'galx') {
    result.galx = v.times(new BigNumber(0.000000000000000001)).toFixed();
  }
  if (unit !== 'cluster') {
    result.cluster = v.times(new BigNumber(0.000000000000000000001)).toFixed();
  }
  if (unit !== 'supermatter') {
    result.supermatter = v.times(new BigNumber(0.000000000000000000000001)).toFixed();
  }
